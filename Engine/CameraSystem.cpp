...
D3DXVECTOR3 CameraSystem::GetPosition()
{
	return D3DXVECTOR3(m_positionX, m_positionY, m_positionZ);
}

D3DXVECTOR3 CameraSystem::GetRotation()
{
...
void CameraSystem::GetViewMatrix(D3DXMATRIX& viewMatrix)
{
